...
from datasets.custom.custom_dataset import PoseDataset as CustomDataset
...
def main():
    ...
    if opt.dataset == 'ycb':
        ...
        dataset = CustomDataset('train', opt.num_points, True, opt.dataset_root, opt.noise_trans, opt.refine_start)
    ...
    if opt.dataset == 'ycb':
        ...
        test_dataset = CustomDataset('test', opt.num_points, False, opt.dataset_root, 0.0, opt.refine_start)
    ...
    for epoch in range(opt.start_epoch, opt.nepoch):
        ...
        if best_test < opt.refine_margin and not opt.refine_start:
            ...
            if opt.dataset == 'ycb':
                ...
                dataset = CustomDataset('train', opt.num_points, True, opt.dataset_root, opt.noise_trans,
                                        opt.refine_start)
            dataloader = torch.utils.data.DataLoader(dataset, batch_size=1, shuffle=True, num_workers=opt.workers)
            if opt.dataset == 'ycb':
                test_dataset = PoseDataset_ycb('test', opt.num_points, False, opt.dataset_root, 0.0, opt.refine_start)
                ...
                test_dataset = CustomDataset('test', opt.num_points, False, opt.dataset_root, 0.0,
                                             opt.refine_start)
